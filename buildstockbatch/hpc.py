...
class SlurmBatch(BuildStockBatchBase):
    ...
    def __init__(self, project_filename):
        ...
        self.apptainer_image = self.get_apptainer_image(
    ...
    def get_apptainer_image(cls, cfg, os_version, os_sha):
        ...
        image_paths = [
            pathlib.Path(sys_img_dir, f"OpenStudio-{os_version}.{os_sha}-{ext}")
        ...
        raise RuntimeError(
            f"Could not find apptainer image: {' or '.join(map(str, image_paths))}"
        )
