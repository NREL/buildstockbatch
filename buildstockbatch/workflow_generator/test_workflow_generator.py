...
def test_residential_hpxml(mocker):
    ...
    assert(simulation_output_step['arguments']['include_timeseries_emissions_fuels'] is False)
    assert(simulation_output_step['arguments']['include_timeseries_emissions_end_uses'] is False)
