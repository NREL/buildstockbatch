...
'''
    ...
    def validate_measures_and_arguments(project_file):
        ...
        measure_names = {
                        measures_dir: {
                                      'BuildExistingModel': ['baseline', 'residential_simulation_controls'],
        ...
        for measure_dir in measure_names.keys():
            for measure_name in measure_names[measure_dir].keys():
                ...
                for yaml_block in measure_names[measure_dir][measure_name]:

                    if yaml_block in cfg.keys() or yaml_block == 'residential_simulation_controls':
                            ...
                            if type(expected_argument_type) is not list:
                                ...
                                if actual_argument_value not in expected_argument_type:
                                    error_msgs += f"* Found unexpected argument value {actual_argument_value} for "\
                                                  f"{yaml_block} in yaml file. Valid values "\
