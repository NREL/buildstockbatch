...
def test_incompatible_os_version(basic_residential_project_file):
    project_filename, results_dir = basic_residential_project_file()

    # Add aws to the project file
    with open(project_filename, 'r') as f:
        cfg = yaml.safe_load(f)
    # Add incompatible OpenStudio version
    cfg['os_version'] = '3.4.0'
    cfg['os_sha'] = '4bd816f785'
    ...
    # Expect a RuntimeError because the OpenStudio version is too low
